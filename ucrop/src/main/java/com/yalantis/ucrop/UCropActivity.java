...
public class UCropActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        boolean freeStyle = intent.getBooleanExtra(UCrop.Options.EXTRA_FREE_STYLE_CROP, OverlayView.DEFAULT_FREESTYLE_CROP_MODE != OverlayView.FREESTYLE_CROP_MODE_DISABLE);
        mOverlayView.setFreestyleCropMode(freeStyle? OverlayView.FREESTYLE_CROP_MODE_ENABLE_WITH_PASS_THROUGH : OverlayView.FREESTYLE_CROP_MODE_DISABLE);
